...
public class SemesterLima extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_semester_lima);

        listView=findViewById(R.id.listSemester5);
    ...
    void kirim_data(final String mNIM) {
        ...
        StringRequest respon = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Adapter5 adapter = new Adapter5(SemesterLima.this, list);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SemesterLima.this);
...
class Adapter5 extends BaseAdapter {
    ...
    public Adapter5(Context context, ArrayList<NilaiSatu> model){
