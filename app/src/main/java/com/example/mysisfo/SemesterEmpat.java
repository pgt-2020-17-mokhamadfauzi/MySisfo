...
public class SemesterEmpat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_semester_empat);

        listView=findViewById(R.id.listSemester4);
    ...
    void kirim_data(final String mNIM) {
        ...
        StringRequest respon = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Adapter4 adapter = new Adapter4(SemesterEmpat.this, list);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SemesterEmpat.this);
...
class Adapter4 extends BaseAdapter {
    ...
    public Adapter4(Context context, ArrayList<NilaiSatu> model){
