...
public class SemesterTiga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_semester_tiga);

        listView=findViewById(R.id.listSemester3);
    ...
    void kirim_data(final String mNIM) {
        ...
        StringRequest respon = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Adapter3 adapter = new Adapter3(SemesterTiga.this, list);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SemesterTiga.this);
...
class Adapter3 extends BaseAdapter {
    ...
    public Adapter3(Context context, ArrayList<NilaiSatu> model){
