...
public class SemesterDua extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_semester_dua);

        listView=findViewById(R.id.listSemester2);
    ...
    void kirim_data(final String mNIM) {
        ...
        StringRequest respon = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Adapter2 adapter = new Adapter2(SemesterDua.this, list);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SemesterDua.this);
...
class Adapter2 extends BaseAdapter {
    ...
    public Adapter2(Context context, ArrayList<NilaiSatu> model){
