...
public class SemesterSatu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_semester_satu);

        listView=findViewById(R.id.listSemester1);
    ...
    void kirim_data(final String mNIM) {
            ...
            StringRequest respon = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        Adapter1 adapter = new Adapter1(SemesterSatu.this, list);
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(SemesterSatu.this);
...
class Adapter1 extends BaseAdapter {
    ...
    public Adapter1(Context context, ArrayList<NilaiSatu> model){
